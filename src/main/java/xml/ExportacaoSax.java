...
public class ExportacaoSax {
    ...
    public void exportar(QuadroDeMedalhas quadroDeMedalhas,
    ...
    private void exportarBronze(TransformerHandler handler, Pais pais) throws SAXException {
    ...
    private void exportarPrata(TransformerHandler handler, Pais pais) throws SAXException {
    ...
    private void exportarOuro(TransformerHandler handler, Pais pais) throws SAXException {
    ...
    private TransformerHandler createHandler() throws TransformerConfigurationException, TransformerFactoryConfigurationError, IllegalArgumentException {
